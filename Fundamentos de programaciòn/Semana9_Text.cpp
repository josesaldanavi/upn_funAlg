...
void altas()
{
    ...
    //ios::app : Abrir para añadir al final (append), sólo utilizable si se ha abierto el fichero exclusivamente para escritura
    ...
    if (escritura.is_open() && consulta.is_open()){
            ...
            consulta>>clave;
            // eof(): Es una funión para determinar el final del archivo
            while (!consulta.eof()){
